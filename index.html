...
<body background="img/fondo.jpeg" id="fondo">
...
<!-- Contenido -->
    <div>
        <div class="velo-negro">
            ...
            <header class="header">
                <a href="index.html">
                    <img src="img/logo.png" alt="logo" class="logo-img" id="logo">
                </a>
            </header>

            <nav>
                <a href="index.html">Tienda</a>
                <a type="submit" id="mostrar" href="#" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="fa-solid fa-cart-plus"></i>Mostrar el carrito</a>
            </nav>
<!-- Modal -->
  ...
  <div class="modal-dialog">
    ...
    <?php }
      ...
      <div class="modal-footer">
        <a href="vacia.php" class="btn btn-danger">Vaciar</a>
        <a href="cotiCorreo.php" class="btn btn-primary">Enviar cotización</a>
      </div>
    </div>
  </div>
</div>
            ...
            <main class="contenedor">
                ...
                ?>
                <form action="carrito_p.php" method="post">
                <div class="producto">
                    ...
                    <button type="submit"  name="agregar" id="agregar"><i class="fa-solid fa-cart-plus"></i>Agregar al carrito</button>
                </div>
                </form>
                <?php
                }
